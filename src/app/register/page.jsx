        ...
        <div className='w-[80%] md:w-[40%] mx-auto my-10'>
            <Card className='border rounded-none space-y-5 my-3'>
                ...
                <Form onSubmit={onSubmit} className="flex flex-col gap-4" >
                    <TextField isRequired name="name" type="name"> <Label>Name</Label>
                        <Input className='dark:bg-slate-700/60' placeholder="Enter your name" />
                        <FieldError />
                    </TextField>

                    <TextField isRequired name="image" type="name">
                        <Label>Image Url</Label>
                        <Input className='dark:bg-slate-700/60' placeholder="Enter your image url" />
                        <FieldError />
                    </TextField>
                    ...
                    <div className="flex gap-2 justify-center">
                        <Button type="submit" className='rounded-md w-full bg-cyan-500 hover:bg-cyan-400 dark:bg-cyan-700'>Register
                        </Button>
