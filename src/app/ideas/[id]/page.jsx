...
//                             <span className='font-semibold text-blue-600'>Tags:</span> {tags}
//                         </p>
//                         <p className='text-gray-600 dark:text-white/55'>
//                             <span className='font-semibold text-blue-600'>Category:</span> {category}
//                         </p>
//                     </div>

//                     <div className='px-3 space-y-2'>
//                         <p className='text-blue-600'>
//                             Target Audience: <span className='text-gray-600 dark:text-white/55'>{targetAudience}</span>
//                         </p>
//                         <p className='text-blue-600'>
//                             Tags: <span className='text-gray-600 dark:text-white/55'>{tags}</span>
//                         </p>
//                         <hr className="my-6 border-t border-slate-250 dark:border-slate-800" />
//                         <p className='text-blue-600'>
//                             Problem Statement: <br />
//                             <span className='text-black dark:text-white'>{problemStatement}</span>
//                         </p>
//                         <p className='text-blue-600'>
//                             Proposed Solution: <br />
//                             <span className='text-black dark:text-white'>{proposedSolution}</span>
//                         </p>
//                     </div>
//                 </div>
//             </div>
...
//             {/* ── Comment Section ── */}
//             {/* ideaId pass করা হচ্ছে যাতে সঠিক idea র comment load হয় */}
